...
import Crear from './src/Calendario/Crear';
...
const AppNavigator = createStackNavigator(
  {
    Login,AuditoriasBuscar,FirmaAuditor,Crear,Crear,Main,CalendarioPrograma,Carusel,Footer,CalendarioVacia,NormaEcBPM,EquipoVacio,EquipoLista,InvitarMiembros,Main, Login, Registro, Home, Reestablecer, AuditoriasVacia, CrearAuditoria, AuditoriasLista, AuditoriasBuscar,FooterAuditoria
  },
  {
    headerMode: 'none',
  }
